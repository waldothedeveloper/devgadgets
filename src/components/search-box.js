...
const SearchBox = ({ refine, currentRefinement }) => (
  <form className="max-w-sm" onSubmit={e => e.preventDefault()}>
    <div className="relative w-full">
      ...
      <label id="searchLabel" htmlFor="search_field" className="sr-only">
        Search for anything
      </label>
      <input
        type="text"
        ...
        className="block w-full h-full pl-8 pr-3 py-2 text-cool-gray-800 rounded-md bg-cool-gray-100 focus:outline-none focus:bg-cool-gray-200 sm:text-sm"
